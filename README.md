...
Semantic HTML is the foundation to a house its the brick/mortar. You must first layout the structure before adding any external items to make it look better.
...
Git is valuable to a team of developers, because it allows you all to work on your part of the job, and leave notes, as well as understand who changed what area.

5. Define mobile-first design in your own words.

Mobile-first design is when you design a webpage to primarily function on a mobile device, thus focusing around the common 800px/500px when building the webpage.
